...
Ext.ux.YearPicker =  Ext.extend(Ext.Component,{
    ...
    constructor: function(config){
        Ext.ux.YearPicker.superclass.constructor.apply(this, arguments);
    ...
    onRender : function(container, position){
        var m = [ '<div style="width: 100px; height:160px;"></div>' ];
    ...
    createYearPicker : function(){
        ...
        this.YearTDs = this.YearPicker.select('td.x-date-mp-year');
        this.freshYear();
        },
    freshYear:function(){
...
Ext.ux.YearMenu = Ext.extend(Ext.menu.Menu,{
    constructor: function(config){
        Ext.apply(this,{
            plain           : true,
            showSeparator   : false,
            items           : this.picker = new Ext.ux.YearPicker({})
            });
        Ext.ux.YearMenu.superclass.constructor.apply(this, arguments);
        this.relayEvents(this.picker, ["select"]);
        }
    });

Ext.ux.YearField = Ext.extend(Ext.form.TriggerField,{
    constructor: function(config){
        Ext.ux.YearField.superclass.constructor.apply(this, arguments);
        this.addEvents('select');
