...
public class TblKqTermKey {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof  TblKqTermKey))
			return false;
		else {
			TblKqTermKey TblKqTermKey = (TblKqTermKey) obj;
			if (null == this.getId() || null == TblKqTermKey.getId())
				return false;
			else
				return (this.getId().equals(TblKqTermKey.getId()));
		}
	}
