...
public class TblCtlMchtSettleInf implements Serializable{
	...
	// primary key
	public com.huateng.po.TblCtlMchtSettleInfPK id;
	...
	public com.huateng.po.TblCtlMchtSettleInfPK getId() {
		return id;
	}

	public void setId(com.huateng.po.TblCtlMchtSettleInfPK id) {
		this.id = id;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.TblCtlMchtSettleInf)) return false;
		else {
			com.huateng.po.TblCtlMchtSettleInf tblCtlMchtSettleInf = (com.huateng.po.TblCtlMchtSettleInf) obj;
