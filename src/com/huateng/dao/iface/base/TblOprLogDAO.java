...
public interface TblOprLogDAO {
	 ...
	 * @param tblRouteInfo a transient instance containing new or updated state 
	 */
	 ...
	 * @param tblRouteInfo a transient instance containing updated state
	 */
	 ...
	 * Remove a persistent instance from the datastore. The argument may be an instance associated with the receiving
	 * Session or a transient instance with an identifier associated with existing persistent state. 
	 * @param tblRouteInfo the instance to be removed
	 */
