 ...
 * @version 1.0
 */
public class TblDestReleInfNDAOTarget extends _RootDAO<TblDestReleInfN> implements TblDestReleInfNDAO{
	...
	public TblDestReleInfN cast (Object object) {
		return (TblDestReleInfN) object;
	}


	public TblDestReleInfN load(TblDestReleInfPK key)
	{
		return (TblDestReleInfN) load(getReferenceClass(), key);
	}

	public TblDestReleInfN get(TblDestReleInfPK key)
	{
		return (TblDestReleInfN) get(getReferenceClass(), key);
	}
