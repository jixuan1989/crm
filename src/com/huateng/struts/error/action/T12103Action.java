...
public class T12103Action extends BaseSupport {
	...
	public String delete(){
		...
		for (int i = 0; i < len; i++) {
			...
			retrivlRef = jsonBean.getJSONDataAt(i).getString("retrivlRef");
			settleDate = jsonBean.getJSONDataAt(i).getString("settleDate");
			String sql = "update tbl_tdb_off_log flag = '05',UPD_DATE='" + CommonFunction.getCurrentDateTime() + "' where MCHNT_ID = '" + mchtNo + "' and TERM_ID = '" 
			+ termId + "' and CUPS_SSN = '" + retrivlRef + "' and CUP_DATE = '" + settleDate + "'";
			commQueryDAO.excute(sql);
			sql = "update report_t80229 set handling = '" + handling + "',flag = '05',UPD_DATE='" + CommonFunction.getCurrentDateTime() + "' where MCHNT_ID = '" + mchtNo + "' and TERM_ID = '" 
			+ termId + "' and CUPS_SSN = '" + retrivlRef + "' and CUP_DATE = '" + settleDate + "'";
					commQueryDAO.excute(sql);
		}
		return returnService(Constants.SUCCESS_CODE);
