...
public class TreeDataAction extends BaseAction {
	...
	protected String subExecute() throws Exception {
		...
		if(StringUtil.isNull(menuMap)){
			//ServletActionContext.getResponse().sendRedirect("timeout.asp");
			return null;
		}
		List<Object> menuList = new LinkedList<Object>();
		//页面初始化
		if(Constants.TREE_INIT_FLG.equals(param)) {
		...
		menuList.add(menuMap.get(param));
		writeMessage(JSONArray.fromObject(menuList).toString());
		return SUCCESS;
	}
